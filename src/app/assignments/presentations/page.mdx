...
- Approximately 7 minutes for each assigned reading:
  ...
  - Key additional details of those contributions (e.g., system details, study design, theoretical insights).
...
## Shared Documents, Submission of Draft Slides, Presentation Group Feedback
