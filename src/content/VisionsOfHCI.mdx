...
- Organize into groups to briefly present one of the above vision papers.
  ...
  Sign up for a paper, and prepare your presentation as 2 to 3 slides in the shared Slides deck:

  <CourseDataLink outerComponent="p" linkKey={courseData.linkDriveVisionsOfHciFolder} />
